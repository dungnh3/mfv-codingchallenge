...
func (_m *UserRepository) GetAccount(ctx context.Context, accountId int64) (*models.UserAccount, error) {
...
func (_m *UserRepository) GetUser(ctx context.Context, userId int64) (*models.User, error) {
...
func (_m *UserRepository) ListAccounts(ctx context.Context, userId int64) ([]*models.UserAccount, error) {
	ret := _m.Called(ctx, userId)
...
func (_m *UserRepository) UpsertUser(ctx context.Context, user *models.User) error {
...
func (_m *UserRepository) UpsertUserAccount(ctx context.Context, userAccount *models.UserAccount) error {
